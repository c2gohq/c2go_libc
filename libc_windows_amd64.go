...
func C2goFileRawFgetws(s *uint16, n int32, f *FILE) *uint16
...
func C2goFileRawFputwc(c uint16, f *FILE) uint32

//go:linkname C2goFileRawFputws github.com/c2gohq/c2go_libc.__c2go_file_raw_fputws
func C2goFileRawFputws(ws *uint16, f *FILE) int32
...
func C2goVsscanfManaged(s *byte, fmt *byte, ap *byte) int32

//go:linkname C2goVswscanfManaged github.com/c2gohq/c2go_libc.__c2go_vswscanf_managed
func C2goVswscanfManaged(s *uint16, fmt *uint16, ap *byte) int32
