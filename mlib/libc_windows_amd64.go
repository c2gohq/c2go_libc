...
func MlibFgetws(text *uint16, count int32, stream *_c2go_mlib_FILE) *uint16
...
func MlibFputwc(character uint16, stream *_c2go_mlib_FILE) uint32

//go:linkname MlibFputws github.com/c2gohq/c2go_libc/mlib.mlib_fputws
func MlibFputws(text *uint16, stream *_c2go_mlib_FILE) int32
...
func MlibFwprintf(stream *_c2go_mlib_FILE, format *uint16, argptrs unsafe.Pointer) int32
...
func MlibPutwc(character uint16, stream *_c2go_mlib_FILE) uint32

//go:linkname MlibPutwchar github.com/c2gohq/c2go_libc/mlib.mlib_putwchar
func MlibPutwchar(character uint16) uint32
...
func MlibVasprintf(output **byte, format *byte, arguments *byte) int32
...
func MlibWcsdup(source *uint16) *uint16
