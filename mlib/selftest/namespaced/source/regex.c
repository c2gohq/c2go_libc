...
#define C2GO_MLIB_TEST_REGEX_T mlib_regex_t
#define C2GO_MLIB_TEST_REGCOMP mlib_regcomp
#define C2GO_MLIB_TEST_REGEXEC mlib_regexec
#define C2GO_MLIB_TEST_REGFREE mlib_regfree
#define C2GO_MLIB_TEST_EXPORT mlib_regex_prefixed_selftest
