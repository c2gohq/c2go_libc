...
#define C2GO_MLIB_TEST_DIR mlib_DIR
#define C2GO_MLIB_TEST_OPENDIR mlib_opendir
#define C2GO_MLIB_TEST_CLOSEDIR mlib_closedir
#define C2GO_MLIB_TEST_SCANDIR mlib_scandir
#define C2GO_MLIB_TEST_EXPORT mlib_dirent_retire_prefixed_selftest
