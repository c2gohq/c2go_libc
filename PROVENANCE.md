...
| `csrc/mlib/glob.c` | Managed adaptation of pinned musl `src/regex/glob.c`; pathname matching retained while allocation, DIR routing, sorting, and release ownership are replaced | MIT identifier retained for the adapted musl implementation | Derivation and managed deltas recorded in-file |
