...
func C2goFileRawFgetws(s *uint32, n int32, f *FILE) *uint32
...
func C2goFileRawFputwc(c uint32, f *FILE) uint32

//go:linkname C2goFileRawFputws github.com/c2gohq/c2go_libc.__c2go_file_raw_fputws
func C2goFileRawFputws(ws *uint32, f *FILE) int32
...
func __wcscoll_l(l *uint32, r *uint32, locale *__locale_struct) int32
func __wcsxfrm_l(dest *uint32, src *uint32, n uint64, loc *__locale_struct) uint64
...
func Fgetws(s *uint32, n int32, f *FILE) *uint32
...
func Fputwc(c uint32, f *FILE) uint32

//go:linkname Fputws github.com/c2gohq/c2go_libc.fputws
func Fputws(ws *uint32, f *FILE) int32
...
func Fwprintf(f *FILE, fmt *uint32, argptrs unsafe.Pointer) int32
...
func Fwscanf(f *FILE, fmt *uint32, argptrs unsafe.Pointer) int32
...
func Mbrtowc(wc *uint32, src *byte, n uint64, st *__mbstate_t) uint64
...
func Mbsnrtowcs(wcs *uint32, src **byte, n uint64, wn uint64, st *__mbstate_t) uint64

//go:linkname Mbsrtowcs github.com/c2gohq/c2go_libc.mbsrtowcs
func Mbsrtowcs(ws *uint32, src **byte, wn uint64, st *__mbstate_t) uint64

//go:linkname Mbstowcs github.com/c2gohq/c2go_libc.mbstowcs
func Mbstowcs(ws *uint32, s *byte, wn uint64) uint64

//go:linkname Mbtowc github.com/c2gohq/c2go_libc.mbtowc
func Mbtowc(wc *uint32, src *byte, n uint64) int32
...
func Putwc(c uint32, f *FILE) uint32
...
func Swprintf(s *uint32, n uint64, fmt *uint32, argptrs unsafe.Pointer) int32

//go:linkname Swscanf github.com/c2gohq/c2go_libc.swscanf
func Swscanf(s *uint32, fmt *uint32, argptrs unsafe.Pointer) int32
...
func Wcrtomb(s *byte, wc uint32, st *__mbstate_t) uint64
...
func WcscasecmpL(l *uint32, r *uint32, locale *__locale_struct) int32
...
func Wcscoll(l *uint32, r *uint32) int32

//go:linkname WcscollL github.com/c2gohq/c2go_libc.wcscoll_l
func WcscollL(l *uint32, r *uint32, loc *__locale_struct) int32
...
func Wcsftime(wcs *uint32, n uint64, f *uint32, tm *tm) uint64

//go:linkname WcsftimeL github.com/c2gohq/c2go_libc.wcsftime_l
func WcsftimeL(wcs *uint32, n uint64, f *uint32, tm *tm, loc *__locale_struct) uint64
...
func WcsncasecmpL(l *uint32, r *uint32, n uint64, locale *__locale_struct) int32
...
func Wcsnrtombs(dst *byte, wcs **uint32, wn uint64, n uint64, st *__mbstate_t) uint64
...
func Wcsrtombs(s *byte, ws **uint32, n uint64, st *__mbstate_t) uint64
...
func Wcstod(s *uint32, p **uint32) float64

//go:linkname Wcstof github.com/c2gohq/c2go_libc.wcstof
func Wcstof(s *uint32, p **uint32) float32

//go:linkname Wcstoimax github.com/c2gohq/c2go_libc.wcstoimax
func Wcstoimax(s *uint32, p **uint32, base int32) int64
...
func Wcsxfrm(dest *uint32, src *uint32, n uint64) uint64

//go:linkname WcsxfrmL github.com/c2gohq/c2go_libc.wcsxfrm_l
func WcsxfrmL(dest *uint32, src *uint32, n uint64, loc *__locale_struct) uint64
...
func Wctomb(s *byte, wc uint32) int32
...
func Wprintf(fmt *uint32, argptrs unsafe.Pointer) int32
...
func Wscanf(fmt *uint32, argptrs unsafe.Pointer) int32
