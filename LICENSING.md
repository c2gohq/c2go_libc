...
| `mlib/`, `internal/posixsync/`, and `csrc/include/c2go/mlib*` | Original managed-libc carrier, shared-state, header, and test material | AGPL-3.0-only or a separate commercial agreement | File-level AGPL identifiers added; project copyright-owner identity remains unresolved |
